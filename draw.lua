function printVectors(x,y)
    ...
    --love.graphics.line(x,y,x + scale * player.forceDrag:x(), y + scale * player.forceDrag:y())
...
function printStats(x,y)
    ...
    love.graphics.print(player.frontSlip, x, y + 40)
    love.graphics.print(player.backSlip, x, y + 60)
    love.graphics.print(player.fLateral.m, x, y + 80)
    love.graphics.print(player.torque, x, y + 100)
    love.graphics.print(player.forceDrag.m, x, y + 120)
end
